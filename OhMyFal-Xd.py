...
for xcTeam in range(1000):
	rr = random.randint
	rc = random.choice
	ngentot1 = f"Dalvik/2.1.0 (Linux; U; Android 10.0.0; MBOX Build/NRD91N.{str(rr(111111,199999))}.001) [FBAN/MessengerLite;FBAV/{str(rr(120,150))}.0.0.2.{str(rr(110,150))};FBPN/com.facebook.mlite;FBLC/en_US;FBBV/{str(rr(200000000,299999999))};FBCR/null;FBMF/vivo;FBBD/vivo;FBDV/vivoV3Max;FBSV/6.0.0;FBCA/armeabi-v7a:armeabi;FBDM/"+"(density-3.0,width=1080,height=1920);FB_FM/1;]"
	if ngentot1 in ngentott:pass
	else:ngentott.append(ngentot1)
	ngentot2 = f"Dalvik/2.1.0 (Linux; U; Android 9.0.0; SM-J120F Build/LMY47X.{str(rr(111111,199999))}.001) [FBAN/MessengerLite;FBAV/{str(rr(120,150))}.0.0.2.{str(rr(110,150))};FBPN/com.facebook.mlite;FBLC/in_ID;FBBV/{str(rr(200000000,299999999))};FBCR/IndosatOoredoo;FBMF/Realme;FBBD/Realme;FBDV/SM-J120F;FBSV/9;FBCA/arm64-v8a:null;FBDM/"+"(density-3.0,width=1080,height=1920);FB_FM/1;]"
	if ngentot2 in ngentott:pass
	else:ngentott.append(ngentot2)
	ngentot3 = f"Dalvik/2.1.0 (Linux; U; Android 8.0; P00A Build/NRD90M.{str(rr(111111,199999))}.001) [FBAN/MessengerLite;FBAV/{str(rr(120,150))}.0.0.2.{str(rr(110,150))};FBPN/com.facebook.orca;FBLC/en_US;FBBV/{str(rr(200000000,299999999))};FBCR/Verizon;FBMF/Google;FBBD/google;FBDV/P00A;FBSV/10;FBCA/arm64-v8a:null;FBDM/"+"{density=2.75,width=1080,height=2028};FB_FW/1;]"
	if ngentot3 in ngentott:pass
	else:ngentott.append(ngentot3)
	ngentot4 = f"Dalvik/2.1.0 (Linux; U; Android 8.0.0; POCO F1 MIUI/V10.0.6.0.OEJMIFH.{str(rr(111111,199999))}.001) [FBAN/MessengerLite;FBAV/{str(rr(120,150))}.0.0.2.{str(rr(110,150))};FBPN/com.facebook.orca;FBLC/en_US;FBBV/{str(rr(200000000,299999999))};FBCR/null;FBMF/vivo;FBBD/vivo;FBDV/POCO F1;FBSV/10;FBCA/armeabi-v7a:armeabi;FBDM/"+"(density-3.0,width=1080,height=1920);FB_FM/1;]"
